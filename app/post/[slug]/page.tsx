        ...
        <div className="prose prose-invert max-w-none space-y-6 mb-16">
          ...
          <div className="border-t border-divider pt-8 mt-12 space-y-4">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-secondary flex items-center justify-center text-lg font-semibold text-foreground flex-shrink-0">
